...
public class TestLoanRecord {
    ...
    @Test
    public void testLoanRecordWithoutParameters() {
        String path = "/sapi/v1/margin/loan";
        ...
        client.createMargin().loanRecord(parameters);
    }

    @Test
    public void testLoanRecord() {
        String path = "/sapi/v1/margin/loan?asset=BNB";
        LinkedHashMap<String,Object> parameters = new LinkedHashMap<>();
