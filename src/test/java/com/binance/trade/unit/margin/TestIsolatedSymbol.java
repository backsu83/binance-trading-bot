...
public class TestIsolatedSymbol {
    ...
    @Test
    public void testIsolatedSymbolWithoutParameters() {
        String path = "/sapi/v1/margin/isolated/pair";
        ...
        client.createMargin().getIsolatedSymbol(parameters);
    }

    @Test
    public void testIsolatedSymbol() {
        String path = "/sapi/v1/margin/isolated/pair?symbol=BNBUSDT";
        LinkedHashMap<String,Object> parameters = new LinkedHashMap<>();
