package com.binance.trade.unit.futures;
...
public class TestCollateralRepayQuote {
    ...
    @Test
    public void testCollateralRepayQuoteWithoutParameters() {
        ...
        client.createFutures().collateralRepayQuote(parameters);
    }

    @Test
    public void testCollateralRepayQuote() {
        String path = "/sapi/v1/futures/loan/collateralRepay?coin=USDT&collateralCoin=BUSD&amount=1";
        LinkedHashMap<String,Object> parameters = new LinkedHashMap<>();
