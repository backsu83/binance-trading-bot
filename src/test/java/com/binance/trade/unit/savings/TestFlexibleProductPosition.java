package com.binance.trade.unit.savings;
...
public class TestFlexibleProductPosition {
    ...
    @Test
    public void testFlexibleProductPositionWithoutParameters() {
        ...
        client.createSavings().flexibleProductPosition(parameters);
    }

    @Test
    public void testFlexibleProductPosition() {
        String path = "/sapi/v1/lending/daily/token/position?asset=BNB";
        LinkedHashMap<String,Object> parameters = new LinkedHashMap<>();
