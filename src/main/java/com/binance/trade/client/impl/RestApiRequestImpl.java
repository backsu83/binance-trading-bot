...
import com.binance.trade.client.impl.utils.JsonWrapperArray;
import com.binance.trade.client.impl.utils.UrlParamsBuilder;
...
class RestApiRequestImpl {
    ...
    RestApiRequest<Order> simplePostOrder(String symbol, OrderSide side, PositionSide positionSide, OrderType orderType,
                                          String quantity, WorkingType workingType, NewOrderRespType newOrderRespType) {
        RestApiRequest<Order> request = new RestApiRequest<>();
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                .putToUrl("symbol", symbol)
                .putToUrl("side", side)
